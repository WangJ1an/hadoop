...
public class ClickStreamPV {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(ClickStreamPV.class);
...
//		 FileOutputFormat.setOutputPath(job, new Path(args[1]));
        ...
        FileInputFormat.setInputPaths(job, new Path("D:\\workspace\\hadoop\\click\\src\\outdata"));
        FileOutputFormat.setOutputPath(job, new Path("D:\\workspace\\hadoop\\click\\src\\pageviews"));
